          ...
          <div id="wrap">
            ...
            <header id="header" className="header">
              <div className="container">
                ...
                {/* End Bars */}
                {/*Navigation*/}
                <nav className="navigation nav-c" id="navigation" data-menu-type={1200}>
                  <div className="nav-inner">
                    <a href="#" className="bars-close" id="bars-close">Close</a>
                    <div className="tb">
                      <div className="tb-cell">
                        <ul className="menu-list text-uppercase">
                          <li className="current-menu-parent">
                            ...
                            <ul className="sub-menu">
                              <li className="current-menu-item"><a href="index.html" title>Home menu 1</a></li>
              ...
              <div className="container">
                ...
                <div className="banner-cn">
                  ...
                  <div className="tab-content">
                    {/* Search Hotel */}
                    <div className="form-cn form-hotel tab-pane active in" id="form-hotel">
                      <h2>Where would you like to go?</h2>
                      <div className="form-search clearfix">
                        <div className="form-field field-destination">
                          <label htmlFor="destination"><span>Destination:</span> Country, City, Airport, Area, Landmark</label>
                          <input type="text" id="destination" className="field-input" />
                        </div>
                        <div className="form-field field-date">
                          <input type="text" className="field-input" placeholder="Check in" id="check-in" />
                        </div>
                        <div className="form-field field-date">
                          <input type="text" className="field-input" placeholder="Check out" id="check-out" />
                        </div>
                        ...
                        <div className="form-submit">
                          <button type="submit" className="awe-btn awe-btn-lager awe-search">Search</button>
                        </div>
                      </div>
                    </div>
                    {/* End Search Hotel */}
                    ...
                    <div className="form-cn form-car tab-pane" id="form-car">
                      ...
                      <div className="form-search clearfix">
                        <div className="form-field field-picking">
                          <label htmlFor="picking"><span>Picking up:</span> City, airport...</label>
                          <input type="text" id="picking" className="field-input" />
                        </div>
                        <div className="form-field field-droping">
                          <input type="text" className="field-input" placeholder="Droping off" />
                        </div>
                        <div className="form-field field-date">
                          <input type="text" className="field-input calendar-input" placeholder="Pink up date" />
                        </div>
                        <div className="form-field field-date">
                          <input type="text" className="field-input calendar-input" placeholder="Drop off date" />
                        </div>
                        <div className="form-submit">
                          <button type="submit" className="awe-btn awe-btn-lager awe-search">Search</button>
                        </div>
                    ...
                    <div className="form-cn form-cruise tab-pane" id="form-cruise">
                      ...
                      <ul className="form-radio">
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-2" id="radio-5" className="radio" />
                            <label htmlFor="radio-5">Popular Cruises</label>
                          </div>
                        </li>
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-2" id="radio-6" className="radio" />
                            <label htmlFor="radio-6">Luxury Cruises</label>
                          </div>
                        </li>
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-2" id="radio-7" className="radio" />
                      ...
                      <div className="form-search clearfix">
                        <div className="form-field field-destination">
                          <label htmlFor="destination2"><span>Destination:</span> Asia...</label>
                          <input type="text" id="destination2" className="field-input" />
                        </div>
                    ...
                    <div className="form-cn form-flight tab-pane" id="form-flight">
                      ...
                      <div className="form-search clearfix">
                        <div className="form-field field-from">
                          <label htmlFor="flight-from"><span>Flight from:</span> Airport</label>
                          <input type="text" name="flightfrom" id="flight-from" className="field-input" />
                        </div>
                        <div className="form-field field-to">
                          <label htmlFor="flight-to"><span>To :</span> Country, Airpor</label>
                          <input type="text" id="flight-to" className="field-input" />
                        </div>
                        <div className="form-field field-date">
                          <input type="text" className="field-input calendar-input" placeholder="Departing" />
                        </div>
                        <div className="form-field field-date">
                          <input type="text" className="field-input calendar-input" placeholder="Returning" />
                        </div>
                    ...
                    <div className="form-cn form-package tab-pane" id="form-package">
                      ...
                      <ul className="form-radio">
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-1" id="radio-1" className="radio" />
                            <label htmlFor="radio-1">Flight + Hotel</label>
                          </div>
                        </li>
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-1" id="radio-2" className="radio" />
                            <label htmlFor="radio-2">Flight + Hotel +Car</label>
                          </div>
                        </li>
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-1" id="radio-3" className="radio" />
                            <label htmlFor="radio-3">Hotel +Car</label>
                          </div>
                        </li>
                        <li>
                          <div className="radio-checkbox">
                            <input type="radio" name="radio-1" id="radio-4" className="radio" />
                      ...
                      <div className="form-search clearfix">
                        <div className="form-field field-from">
                          <label htmlFor="filghtfrom"><span>Flight From:</span> Airport...</label>
                          <input type="text" id="filghtfrom" className="field-input" />
                        </div>
                        <div className="form-field field-to">
                          <label htmlFor="flightto"><span>To:</span> Country, Airport</label>
            ...
            <section className="sales">
              ...
              <div className="title-wrap">
                <div className="container">
                  ...
                  <a href="#" title className="awe-btn awe-btn-5 awe-btn-lager arrow-right text-uppercase float-right">ALL SALES</a>
                </div>
              </div>
              {/* End Title */}
              {/* Hot Sales Content */}
                      ...
                      <div className="sales-item">
                        ...
                        <div className="home-sales-text">
                          ...
                          <div className="price-box">
                            <span className="price old-price">From  <del>$269</del></span>
                            <span className="price special-price">$175<small>/night</small></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-xs-6 col-md-3">
                      <div className="sales-item">
                        ...
                        <div className="home-sales-text">
                          ...
                          <hr className="hr" />
                          <div className="price-box">
                            <span className="price old-price">From  <del>$632</del></span>
                            <span className="price special-price">$345<small>/night</small></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="sales-item ">
                        ...
                        <div className="home-sales-text">
                          ...
                          <hr className="hr" />
                          <div className="price-box">
                            <span className="price old-price">From  <del>$582</del></span>
                            <span className="price special-price">$258<small>/night</small></span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="sales-item">
                        ...
                        <div className="home-sales-text">
                          ...
                          <hr className="hr" />
                          <div className="price-box">
                            <span className="price old-price">From  <del>$457</del></span>
                            <span className="price special-price">$258<small>/night</small></span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-xs-6 col-md-3">
                      <div className="sales-item">
                        ...
                        <div className="home-sales-text">
                          ...
                          <hr className="hr" />
                          <div className="price-box">
                            <span className="price old-price">From  <del>$354</del></span>
                            <span className="price special-price">$255<small>/night</small></span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <section className="destinations">
              ...
              <div className="title-wrap">
                <div className="container">
                  ...
                  <a href="#" title className="awe-btn awe-btn-5 arrow-right awe-btn-lager text-uppercase float-right">view all</a>
                </div>
              </div>
              {/* End Title */}
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4 col-lg-3">
                      <div className="intro-filter">
                        ...
                        <ul className="filter">
                          <li className="active">
                            <a data-toggle="tab" href="#destinations-1"><i className="fa fa-map-marker" /> Recommendation for you</a>
                          </li>
                          <li>
                            <a data-toggle="tab" href="#destinations-2"><i className="fa fa-map-marker" /> Australia &amp; Oceania</a>
                          </li>
                          <li>
                            <a data-toggle="tab" href="#destinations-3"><i className="fa fa-map-marker" /> Asia</a>
                          </li>
                          <li>
                            <a data-toggle="tab" href="#destinations-4"><i className="fa fa-map-marker" /> Europe</a>
                          </li>
                          <li>
                            <a data-toggle="tab" href="#destinations-5"><i className="fa fa-map-marker" /> USA &amp; Canada</a>
                          </li>
                          <li>
                            <a data-toggle="tab" href="#destinations-6"><i className="fa fa-map-marker" /> The rest of the world</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="col-md-8 col-lg-9">
                      <div className="tab-content destinations-grid">
                        {/* Tab One */}
                        <div id="destinations-1" className="clearfix tab-pane fade active in ">
                          {/* Destinations Item */}
                        ...
                        <div id="owl-magazine-ds">
                          ...
                          <div className="magazine-item">
                            ...
                            <div className="magazine-footer clearfix">
                              ...
                              <a href title className="awe-btn awe-btn-5 arrow-right awe-btn-lager text-uppercase float-right">view more</a>
                            </div>
                          </div>
                    ...
                    <div className="subscribe">
                      ...
                      <div className="subscribe-form">
                        <form action="#" method="get">
                          <input type="text" name defaultValue placeholder="Your email" className="subscribe-input" />
                          <button type="submit" className="awe-btn awe-btn-5 arrow-right text-uppercase awe-btn-lager">subcrible</button>
                        </form>
                      </div>
                      {/* End Subscribe Form */}
                      {/* Follow us */}
                      <div className="follow-us">
                        ...
                        <div className="follow-group">
                          ...
                          <a href title><i className="fa fa-google-plus" /></a>
                          <a href title><i className="fa fa-digg" /></a>
                        </div>
                      </div>
                      {/* Follow us */}
                    </div>
                  ...
                  <div className="col-sm-6 col-md-4">
                    ...
                    <div className="currency-lang-bottom dropdown-cn float-left">
                      <div className="dropdown-head">
                        <span className="angle-down"><i className="fa fa-angle-down" /></span>
                      </div>
