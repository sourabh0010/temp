...
$(document).ready(function () {
    ...
    function SubMenuClick() {
        $('.navigation .menu-parent').on('click', '> a', function(e) {
            e.preventDefault();
            var $el = $(this),
                menuType = $('.navigation').data('menu-type'),
                windowWidth = window.innerWidth;
            if (windowWidth < menuType) {
                if($el.parent().hasClass('active')==false) {
                    $el
                        .parent('li')
                        .siblings()
                            .removeClass('active')
    ...
    function BannerVideoBackground() {
        if( !isMobile.any() ) {
            ...
            $('.banner-video-control').remove();
            $('#banner-player').remove();
        }
    }
    ...
    function parallaxInit() {
        if(!isMobile.any()){
            ...
            $('.bg-parallax').removeClass('bg-parallax').addClass('bg-scroll');
        }
    }
